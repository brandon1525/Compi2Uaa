...
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
	 ...
	 */
	public TextLineNumber( JTextComponent component /*, JLabel jlRC */ ) {
		this( component, 3 );
		//this.jlRC = jlRC;
	}
...
//
	...
	public void caretUpdate( CaretEvent e ) {
		...
		jlRC.setText( ( row + 1 ) + " : " + ( col + 1 ) );*/
		
//		Element lineElem = root.getElement( currentLine );
//		int col = caretPosition - lineElem.getStartOffset();
//		jlRC.setText( ( currentLine + 1 ) + " : " + ( col + 1 ) );
	}
